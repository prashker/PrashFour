...
PrashFour.prototype.start = function () {
    ...
    if (this.server.address()) console.log('PrashFour started at %s:%s', this.server.address().address, this.server.address().port);
}
...
app.configure(function(){
    ...
    app.set('client_port', process.env.CLIENT_PORT || config.port);
